...
from agentbot.guards import GuardRejected, check_input, check_output
...
def test_framework_catches_names_the_regex_cannot(text):
    ...
    from agentbot.guards.framework import build_guard
    from agentbot.guards.patterns import find_pii
    ...
    from agentbot.guards.input_guard import _check_framework
