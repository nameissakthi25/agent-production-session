...
from ragbot.guards.patterns import find_injection, find_pii
...
def test_framework_catches_names_the_regex_cannot(text):
    ...
    from ragbot.guards.framework import build_guard
    from ragbot.guards.patterns import find_pii
    ...
    from ragbot.guards.input_guard import _check_framework
