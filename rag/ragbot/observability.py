...
def record_feedback(trace_id: str | None, helpful: bool, question: str = "",
    ...
    row = {
        ...
        "helpful": helpful,
        "question": question,
        # For a RAG answer the citations belong with the thumb. Without them a
        # thumbs-down is ambiguous: bad retrieval, or bad generation from good
        # retrieval? With them it is a replayable test case.
        **(extra or {}),
    }
